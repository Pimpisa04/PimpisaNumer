          ...
          <Sider width={335} style={{ background: "#fff" }}>
            ...
            >
              <SubMenu key="root_submenu" title={<span><Icon type="user"  />Root of Equation</span>}>
                <Menu.Item key="menu_graphical" >Graphical Method</Menu.Item>
                <Menu.Item key="menu_bisection" >Bisection Method</Menu.Item>
                <Menu.Item key="menu_false">False Position Method</Menu.Item>
                <Menu.Item key="menu_onepoint">One-Point Iteration Method</Menu.Item>
                <Menu.Item key="menu_newton">Newton-Raphson Method</Menu.Item>
                <Menu.Item key="menu_secant">Secant Method Method</Menu.Item>
              </SubMenu>
