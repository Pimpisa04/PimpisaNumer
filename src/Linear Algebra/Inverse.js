    ...
    render() {
        return(
            ...
            <div class="container-fluid" onChange={this.handleChange}>
                <alert color="danger"><h1><p className="text-danger">MATRIX INVERSION</p></h1></alert>
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-danger btn-lg btn-block" onClick={ ()=>this.inverse(this.state.n)}>
                        ENTER</button>
                    </div>
                </div>
                }
