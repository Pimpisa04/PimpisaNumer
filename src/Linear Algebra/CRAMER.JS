...
class Cramer extends Component {
    ...
    cramer = () => {
        ...
        while (counter != this.state.n) { 
            ...
            answer.push(<h2><p className="text-danger">X<sub>{counter}</sub>=&nbsp;&nbsp;{Math.round(math.det(transformMatrix))/Math.round(math.det(A))}</p></h2>)
            answer.push(<br/>)
            counter++;
    ...
    render() {
        return(
            ...
            <div class="container-fluid" onChange={this.handleChange}>
                <alert color="danger"><h1><p className="text-danger">CRAMER'S RULE</p></h1></alert>
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-danger btn-lg btn-block" onClick={ () => this.cramer()}>
                        ENTER</button>
                    </div>
                </div>
                }
