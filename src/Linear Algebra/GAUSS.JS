...
class Gauss extends Component {
    ...
    gauss = (n) => {
        ...
        for (i=0 ; i<n ; i++) {
            output.push(<h2><p className="text-danger">X<sub>{i}</sub>=&nbsp;&nbsp;{X[i]}</p></h2>);
            output.push(<br/>)
        }
    ...
    render() {
        return(
            ...
            <div class="container-fluid" onChange={this.handleChange}>
                <alert color="danger"><h1><p className="text-danger">GAUSS'S ELIMINATION</p></h1></alert>
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-danger btn-lg btn-block" onClick={ ()=>this.gauss(this.state.n)}>
                        ENTER</button>
                    </div>
                </div>
                }
