...
class Jordan extends Component {
    ...
    jordan = (n) => {
        ...
        for (i=0 ; i<n ; i++) {
            output.push(<h2><p className="text-danger">X<sub>{i}</sub>=&nbsp;&nbsp;{B[i]}</p></h2>);
            output.push(<br/>)
        }
        this.setState({
            showOutput: true
    ...
    render() {
        return(
            ...
            <div class="container-fluid" onChange={this.handleChange}>
                <alert color="danger"><h1><p className="text-danger">GAUSS JORDAN METHOD</p></h1></alert>
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-danger btn-lg btn-block" onClick={ ()=>this.jordan(this.state.n)}>
                        ENTER</button>
                    </div>
                </div>
                }
