...
class Polynomial extends Component {
    ...
    findX = (m) => {
        ...
        for (i=0 ; i<=m ; i++) {
            ...
            output.push(<h2><p className="text-danger">X = {this.state.X}</p></h2>)
    ...
    render() {
        return(
            ...
            <div class="container-fluid">
                ...
                <alert color="danger"><h1><p className="text-danger">POLYNOMIAL REGRESSION</p></h1></alert>
                        ...
                        <div class="card-body">
                            <form>
                                <div class="form-row" onChange={this.handleChange}>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="m"><p className="text-danger">ORDER (M)</p></label>
                ...
                <div class="card">
                    <div class="card-body">
                    <h2><p className="text-danger">{parseInt(this.state.m) === 1 ? "LINEAR":"POLYNOMIAL"}REGRESSION</p></h2>
                    ...
                    <div class="card-footer">
                            <button class="btn btn-danger btn-lg btn-block" onClick= {()=> {this.initialValue(parseInt(this.state.nPoints), parseInt(this.state.m)); 
                                        this.polynomial(parseInt(this.state.nPoints), parseInt(this.state.m))}}>ENTER</button>
                    </div>                    
                    </div>
                </div>
                }
