    ...
    render() {
        return(
            ...
            <div class="container-fluid">
                ...
                <alert color="danger"><h1><p className="text-danger">EULER'S METHOD</p></h1></alert>
                ...
                <div class="card">
                        ...
                        <div class="card-footer">
                            <button class="btn btn-danger btn-lg btn-block" onClick= {
                                ()=>this.euler(parseFloat(this.state.start),  parseFloat(this.state.finish), parseFloat(this.state.y0), parseFloat(this.state.h))
                            }>ENTER</button>
                        </div>
                </div>
