    ...
    render() {
        return(
            ...
            <div class="container-fluid">
                ...
                <alert color="danger"><h1><p className="text-danger">ONE-POINT ITERATION METHOD</p></h1></alert>
                            ...
                            <form>
                                <div class="form-row" onChange={this.handleChange}>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="fx" placeholder="2-e^(x/4)" value={this.state.fx}/>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="x0"><p className="text-danger">INITIAL NUMBER (X0)</p></label>
                ...
                <div class="card">
                    <div class="card-body">
                        <Plot
                                ...
                                layout={ {title: 'One-Point Iteration Method'} }
