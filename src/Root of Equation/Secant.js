    ...
    render() {
        return(
            ...
            <div class="container-fluid">
                ...
                <alert color="danger"><h1><p className="text-danger">SECANT METHOD</p></h1></alert>
                            ...
                            <form>
                                <div class="form-row" onChange={this.handleChange}>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="x0"><p className="text-danger">INITIAL NUMBER1 (X0)</p></label>
                                        <input type="text" class="form-control" name="x0" placeholder="0.5" value={this.state.x0}/>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="x1"><p className="text-danger">INITIAL NUMBER2 (X1)</p></label>
