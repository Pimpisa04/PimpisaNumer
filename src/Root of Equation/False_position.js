    ...
    render () {
        return(
            ...
            <div class="container-fluid">
                ...
                <alert color="danger"><h1><p className="text-danger">FALSE-POSITION METHOD</p></h1></alert>
                            ...
                            <form>
                                <div class="form-row" onChange={this.handleChange}>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="xl"><p className="text-danger">NUMBER START (XL)</p></label>
                                        <input type="text" class="form-control" name="xl" placeholder="0" value={this.state.xl}/>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="xr"><p className="text-danger">NUMBER END (XR)</p></label>
