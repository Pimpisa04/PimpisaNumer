    ...
    render() {
        return(
            ...
            <div class="container-fluid">
                ...
                <alert color="danger"><h1><p className="text-danger">GRAPHICAL METHOD</p></h1></alert>
                            ...
                            <form>
                                <div class="form-row" onChange={this.handleChange}>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="start"><p className="text-danger">START</p></label>
                                        <input type="text" class="form-control" name="start" placeholder="0" value={this.state.start}/>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="finish"><p className="text-danger">FINISH</p></label>
